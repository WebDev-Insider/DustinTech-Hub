        ...
        <Sheet>
          ...
          <SheetContent side="left" className="flex flex-col p-0">
            <div className="flex-1 overflow-y-auto">
              <nav className="flex flex-col gap-1 text-base font-medium p-4">
                {navbarLinks.map((item) => (
                  <Link 
                    key={item.id} 
                    href={item.href} 
                    className="px-3 py-2.5 rounded-md hover:bg-muted transition-colors flex items-center"
                  >
                    {item.name}
                  </Link>
                ))}
                <div className="mt-2 px-3 text-sm text-muted-foreground">More</div>
                {moreItems.map((item) => (
                  <Link 
                    key={item.href} 
                    href={item.href} 
                ...
                <div className="p-4 space-y-3">
                  <div className="flex items-center gap-3 px-2 py-2">
                    ...
                    <div className="min-w-0">
                      <p className="text-sm font-medium truncate">{user.given_name} {user.family_name}</p>
